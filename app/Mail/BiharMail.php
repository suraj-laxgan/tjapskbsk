...
class BiharMail extends Mailable
{
    ...
    public function build()
    {
        ...
        ->view('admin.mail.mailsend.mailbodyBr',compact('mem_id','mem_email','mem_nm','application_no','add_city','add_postofc','add_ps','add_dist',));
    }
}
