...
@section('title')
	Verify New Existing Member Edit
@endsection
@section('style')
<style>
...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('verify-new-edit-upload') }}"  enctype="multipart/form-data">
                @csrf
                <div class='row'>
                    <div class="card-body"style='border: 1px solid rgb(200,200,200);box-shadow: 0px 0px 5px 0px rgb(200 200 200);'>
                        
                        <div class="col-sm-12" style="margin-top: 5px">
                             <input type="hidden"  name="kbsk_id" value="{{ $mem_edit->kbsk_id }}" >
                             <input type="hidden"  name="state_id" value="{{ $mem_edit->state_id }}" >
                             {{-- <input type="text"  name="new_id" value="{{ $mem_edit->new_id }}" > --}}

                             <select name="state_id" id="state_n" class="form-controls"         onChange="findStateName()" disabled="true">
                    ...
                    <div class="card-body"style='border: 1px solid rgb(200,200,200);box-shadow: 0px 0px 5px 0px rgb(200 200 200);'>
                        ...
                        <div class="col-sm-12" style="padding-top: 5px">
                            <input type="file" id="profile_pic" name="profile_pic" class="form-controls"   >
                            <img src="{{ asset('photo_kbsk_new/'.$mem_edit->profile_pic) }}" 
...
@if ($mem_edit->des_type != '')
    ...
    // alert(mem_desig);
        ...
        success:function(data)
        {
        var place_of_post = '<option value="">Select place of post</option>';
                    $.each( data, function( index, value )
                    {
