				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<td width="90%" valign="top">
						...
						<span style="font-size:14px; font-weight:700;">No. BR/{{ $application_no }}</span>
						...
						<div style="font-size:14px; font-weight:700">{{ $mem_nm }}</div>
						<div style="font-size:14px; font-weight:700">{{ $add_city }},{{ $add_postofc }}</div>
						<div style="font-size:14px; font-weight:700">{{ $add_ps }},{{ $add_dist }}.</div>
						<div style="height:58px"></div>
						<div style="font-size:14px; font-weight:700;" align="center">Sub: E Verification.</div>
						<div style="font-size:14px;text-indent: 5%; text-align: justify; font-weight:500;">{{ $mem_nm }} is requested to upload the scanned copy of your qualifications & experience in our site.
						</div>
						<div style="font-size:14px;text-indent: 5%; text-align: justify; font-weight:500; margin-top:5px;">A certificate issued by government group A Officer or Head Master of School/ PanchayatPradhan/ Municipality Chairman/ M.L.A./ M.P./ Sabhapati/ Sabhadhipati in the following proforma is also to be uploaded.
  						</div>
						...
						<div style="font-size:14px;text-indent: 5%; text-align: justify;">I personally know Mr./ Mrs.................................................................... .......... .......... ......... for the last .......... .............years. He/ She bears a good moral character. He/ She addressed at
						</div>
						<div>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr>
						...
						<div style="font-size:14px;text-indent: 5%; text-align: justify; font-weight:500; margin-top:10px;">Requested to submit within 15 working days.</div>
						<div style="margin-top:10px">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td width="50%"></td>
								<td width="50%">-Soumen Koley (Secretary)</td>
							  </tr>
							</table>
						</div>
						<div style="font-size:14px;text-indent: 1%; text-align: justify; margin-top:10px;">
							<li>Send all of your documents in <b>PDF Format</b> to <b> kbskdmt.hr@gmail.com.</b></li>
							<li>Letter issued by mail does not requires signature.</li></br>
							<a href = {{route('pdf.generatebr',['mem_id' => $mem_id])}}>Click here to download pdf</a></br>
							<li>{{ $mem_email }}</li>
						</div>
					</td>
					<td width="5%"></td>
