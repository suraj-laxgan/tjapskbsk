...
<div class="container-fluid">
    ...
    <h6 style="margin-left:30px">
       <u> Registration form for : {{ Auth::guard('stateUser')->user()->state_nm }}</u>
    </h6>
    @endsection
    ...
    <div class="col-md-12" style="margin-top: -15px">
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('/state-member-regis') }}"  enctype="multipart/form-data">
                @csrf
                <div class='row'>
                    <div class="card-body"style='border: 1px solid rgb(200,200,200);box-shadow: 0px 0px 5px 0px rgb(200 200 200);'>
                        ...
                        <div class="col-sm-12">
                            <input type="text" id="media_nm" class="register_input" name="media_nm" value="{{ old('media_nm') }}"  autocomplete="off"/>
                            <label for="register_input" placeholder="Enter Media Name  *"></label>
                        </div>
                        <div class="col-sm-12">
                            <input type="text" placeholder="Enter Members From" id="entry_dt" name="entry_dt" class="register_input{{ $errors->has('entry_dt') ? ' is-invalid' : '' }}" value="" autocomplete="off" readonly="true" style="background-color: #ffffff;">
                        </div>
                        <div class="col-sm-12" style="padding-top: 5px">
                            <input type="text" id="contact_no" class="register_input" name="contact_no" value="{{ old('contact_no') }}"  autocomplete="off"/>
                            <label for="register_input" placeholder="Enter Contact No  *"></label>
                        </div>
                        <div class="col-sm-12">
                            <input type="email" id="mem_email" class="register_input" name="mem_email" value="{{ old('mem_email') }}"  autocomplete="off"/>
